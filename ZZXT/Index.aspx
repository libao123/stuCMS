...
<body class="hold-transition skin-blue sidebar-mini">
			    ...
			    <div class="navbar-custom-menu" id="headMenu">
			        <ul class="nav navbar-nav">
			          	<li class="dropdown user user-menu">
					        <a href="#" class="dropdown-toggle login-in-out" data-toggle="dropdown" aria-expanded="false">
							...
							<ul class="dropdown-menu">
			              			<li class="user-header">
						                ...
						                <p>
						                  	<span><%= user.User_Name %> - <%= strUserRole%></span>
						                  	<small>账号：<%= user.User_Id %></small>
						                </p>
			              			</li>
			              			<li class="user-footer">
			              				<div class="pull-left">
                                        	<a href="#"
                                            <%if (user.User_Type.Equals("S"))
                                              { %>
			                  		        data-href="/AdminLTE_Mod/BDM/PersonalCenter/BasicInfo.aspx"
                                            <%}
                                              else
                                              { %>
                                            data-href="/AdminLTE_Mod/BDM/COUN/list.aspx?page_from=index"
                                            <%} %>
                                            data-title="个人信息" class="btn btn-default btn-flat" id="user-record">用户档案</a>
			                			</div>
			                			<div class="pull-right">
			                  				<a href="#" class="btn btn-default btn-flat" id="login-out">安全退出</a>
			                			</div>
			              			</li>
			            	</ul>
			          	</li>
    ...
    <script type="text/javascript">
        $(function () {
            /*iframe高度自适应*/
            var siH = $(".main-sidebar").height() - $("#Hui-tabNav").height() - 2 - 55;
            ...
            $("#login-out").on("click", function () {
                if (confirm('是否要退出')) {
                    console.log('退出');
                    window.location.href = "user_abandon.aspx";
                } else {
                    console.log('继续');
                }
            });
            ...
            $(".main-sidebar").on('resize', function () {
                var _siderH = $(this).height();
                var _footH = $('.main-footer').height() + 30;
                $("#iframe_box").height(_siderH - _footH - 35);
            });
        });
    </script>
</body>
