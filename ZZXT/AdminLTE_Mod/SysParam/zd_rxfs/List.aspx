<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AltMaster.Master" AutoEventWireup="true"
    CodeBehind="List.aspx.cs" Inherits="PorteffAnaly.Web.AdminLTE_Mod.SysParam.zd_rxfs.List" %>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input name="MC" id="MC" type="text" class="form-control" maxlength="20" placeholder="字典名称" />
                    </div>
                </div>
                <div class="form-group">
