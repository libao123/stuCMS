<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AltMaster.Master" AutoEventWireup="true"
    CodeBehind="List.aspx.cs" Inherits="PorteffAnaly.Web.AdminLTE_Mod.BDM.NationalData.Schoolar.List" %>
            ...
            mainList = tablePackageMany.createOne({
                ...
                hasSearch: {
                    "cols": [
                        ...
                        { "data": "EXPORT_TYPE", "pre": "导出类型", "col": 12, "type": "select", "ddl_name": "ddl_jz_export_type" }
				    ]
                },
        ...
        function loadModalBtnInit() {
            ...
            _content.on('click', "#export", function () {
                ...
                if (STU_TYPE == "B") {//本科生
                    ...
                    if (EXPORT_TYPE == "A" || EXPORT_TYPE == "B" || EXPORT_TYPE == "C") {
                        easyAlert.timeShow({
                            "content": "选择的学生类型与导出类型冲突！",
                            "duration": 3,
                            "type": "info"
                ...
                window.open('/Excel/ExportExcel/ExportExcel.aspx?optype=national_schoolarapply' + GetSearchUrlParam());
            });
            //【审核流程跟踪】
            //------------------审核流程跟踪 开始------------------------------------------
