<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AltMaster.Master" AutoEventWireup="true" CodeBehind="SchoolarApprove.aspx.cs" 
    Inherits="PorteffAnaly.Web.AdminLTE_Mod.BDM.Statistics.SchoolarApprove" %>
    ...
    <script type="text/javascript">
        ...
        function loadTableList() {
            ...
            tablePackageMany.filed = [
				...
				{ "data": "F_NUM", "head": "辅导员待审", "type": "td-keep" },
				{ "data": "Y_NUM", "head": "院级待审", "type": "td-keep" },
				{ "data": "X_NUM", "head": "校级待审", "type": "td-keep" },
				{ "data": "PEND_NUM", "head": "待审总数", "type": "td-keep" },
                { "data": "PASS_NUM", "head": "通过人数", "type": "td-keep" },
                { "data": "DST_NUM", "head": "困难生", "type": "td-keep" },
                { "data": "APPLY_NUM", "head": "分配名额", "type": "td-keep" },
