...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
        ...
        <div class="modal-dialog modal-dw80">
            <div class="modal-content form-horizontal">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">奖助项目设置</h4>
                </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="tab_1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control" name="APPLY_YEAR" id="APPLY_YEAR" d_value='' ddl_name='ddl_year_type' show_type='t'>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4" style="position: relative;">
                                        <input name="APPLY_START" id="APPLY_START" type="text" class="form-control datep" placeholder="开始时间" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control" name="SCORE_YEAR" id="SCORE_YEAR" d_value='' ddl_name='ddl_year_type' show_type='t'>
                                        </select>
                                    </div>
                                    ...
                                    <label class="col-sm-2 control-label">
                                        设立单位</label>
                                    <div class="col-sm-4">
                                        <input name="PROJECT_DEPARTMENT" id="PROJECT_DEPARTMENT" type="text" class="form-control" placeholder="设立单位" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">项目简介</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="PROJECT_REMARK" id="PROJECT_REMARK" rows="5" cols=""></textarea>
                                    </div>
                                </div>
                            </div>
                            <!--项目信息 结束-->
                            ...
                            <div class="tab-pane" id="tab_2">
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">综合考评总分排名：位于前</label>
                                    <div class="col-sm-7">
                                        <input name="Limit_ComRank_Value" id="Limit_ComRank_Value" type="text" class="form-control" placeholder="综合考评总分排名" maxlength="8" />
                                    </div>
                                    <label class="col-sm-1 control-label" style="text-align: left;">名</label>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">综合考评总分：位于前</label>
                                    <div class="col-sm-2">
                                        <input name="Limit_ComScore_RankPer" id="Limit_ComScore_RankPer" type="text" class="form-control" placeholder="综合考评总分" maxlength="5" />
                                    </div>
                                    <!-- </div><div class="form-group col-sm-6"> -->
                                    <label class="col-sm-3 control-label">% / 分数大于</label>
                                    <div class="col-sm-2">
                                        <input name="Limit_ComScore_Score" id="Limit_ComScore_Score" type="text" class="form-control" placeholder="分数大于" maxlength="5" />
                                    </div>
                                    <label class="col-sm-1 control-label" style="text-align: left;">分</label>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">操行能单项综合分：位于前</label>
                                    <div class="col-sm-2">
                                        <input name="Limit_Conduct_RankPer" id="Limit_Conduct_RankPer" type="text" class="form-control" placeholder="操行能单项综合分" maxlength="5" />
                                    </div>

                                    <label class="col-sm-3 control-label">
                                        % / 分数大于</label>
                                    <div class="col-sm-2">
                                        <input name="Limit_Conduct_Score" id="Limit_Conduct_Score" type="text" class="form-control" placeholder="分数大于" maxlength="5" />
                                    </div>
                                    <label class="col-sm-1 control-label" style="text-align: left;">分</label>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">课程能单项综合分：位于前</label>
                                    <div class="col-sm-2">
                                        <input name="Limit_Course_RankPer" id="Limit_Course_RankPer" type="text" class="form-control" placeholder="课程能单项综合分" maxlength="5" />
                                    </div>

                                    <label class="col-sm-3 control-label">% / 分数大于</label>
                                    <div class="col-sm-2">
                                        <input name="Limit_Course_Score" id="Limit_Course_Score" type="text" class="form-control" placeholder="分数大于" maxlength="5" />
                                    </div>
                                    <label class="col-sm-1 control-label" style="text-align: left;">分</label>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">体艺能单项综合分：位于前</label>
                                    <div class="col-sm-2">
                                        <input name="Limit_BodyArt_RankPer" id="Limit_BodyArt_RankPer" type="text" class="form-control" placeholder="体艺能单项综合分" maxlength="5" />
                                    </div>

                                    <label class="col-sm-3 control-label">% / 分数大于</label>
                                    <div class="col-sm-2">
                                        <input name="Limit_BodyArt_Score" id="Limit_BodyArt_Score" type="text" class="form-control" placeholder="分数大于" maxlength="5" />
                                    </div>
                                    <label class="col-sm-1 control-label" style="text-align: left;">分</label>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">
                                        职业技能单项综合分：位于前</label>
                                    <div class="col-sm-2">
                                        <input name="Limit_JobSkill_RankPer" id="Limit_JobSkill_RankPer" type="text" class="form-control" placeholder="职业技能单项综合分" maxlength="5" />
                                    </div>

                                    <label class="col-sm-3 control-label">% / 分数大于</label>
                                    <div class="col-sm-2">
                                        <input name="Limit_JobSkill_Score" id="Limit_JobSkill_Score" type="text" class="form-control" placeholder="分数大于" maxlength="5" />
                                    </div>
                                    <label class="col-sm-1 control-label" style="text-align: left;">分</label>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">操行、课程、体艺、职业技能分项任三个前：</label>
                                    <div class="col-sm-2">
                                        <input name="Limit_Three_RankPer" id="Limit_Three_RankPer" type="text" class="form-control" placeholder="任三个" maxlength="5" />
                                    </div>

                                    <label class="col-sm-3 control-label">
                                        %，另一个可放宽至</label>
                                    <div class="col-sm-2">
                                        <input name="Limit_One_RankPer" id="Limit_One_RankPer" type="text" class="form-control" placeholder="另一个可放宽至" maxlength="5" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control" name="Limit_Grade_Value" id="Limit_Grade_Value" d_value='' ddl_name='ddl_grade' show_type='t'>
                                        </select>
                                    </div>
                                    <label class="col-sm-3 control-label">（含）以上</label>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">专业（可多选）：</label>
                                    <div class="col-sm-9">
    ...
    <div class="modal fade" id="tableModal_Num">
        <div class="modal-dialog modal-dw60">
            <form action="#" method="post" id="form_num" name="form_num" class="modal-content form-horizontal" onsubmit="return false;">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span></button>
                <h4 class="modal-title">可通过学院审核的人数设置</h4>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-save" id="btnsave_num">确定</button>
                <button type="button" class="btn btn-default pull-left" data-dismiss="modal">关闭</button>
            </div>
            </form>
        </div>
    ...
    <div class="modal fade" id="tableModal_Notboth">
        <div class="modal-dialog">
            <form action="#" method="post" id="form_notboth" name="form_notboth" class="modal-content form-horizontal" onsubmit="return false;">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span></button>
                <h4 class="modal-title">不可兼得设置</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label">学年<span style="color: red">*</span></label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label">项目级别<span style="color: red">*</span></label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label">申请表格类型<span style="color: red">*</span></label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label">不可兼得项目<span style="color: red">*</span></label>
                    <div class="col-sm-8">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-save" id="btnsave_notboth">确定</button>
                <button type="button" class="btn btn-default pull-left" data-dismiss="modal">关闭</button>
            </div>
            </form>
        </div>
