<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AltMaster.Master" AutoEventWireup="true"
    CodeBehind="BasicList.aspx.cs" Inherits="PorteffAnaly.Web.AdminLTE_Mod.BDM.Loan.ProjectCheck.BasicList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">
                        项目类型</label>
                    <div class="col-sm-4">
                        <input name="LOAN_TYPE_NAME" id="LOAN_TYPE_NAME" type="text" class="form-control"
                            placeholder="项目类型" />
                    </div>
                    ...
                    <label class="col-sm-2 control-label">
                        项目学年</label>
                    <div class="col-sm-4">
                        <input name="LOAN_YEAR_NAME" id="LOAN_YEAR_NAME" type="text" class="form-control"
                            placeholder="项目学年" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">
                        核对事项说明<span style="color: red">*</span>
                    </label>
                    <div class="col-sm-10">
    ...
    <!-- 编辑界面 结束-->
    <!-- 发布公告编辑界面 开始 -->
    <div class="modal" id="tableModal_Notice">
        <div class="modal-dialog modal-dw60">
    ...
    <script type="text/javascript">
        ...
        function loadTableList() {
            ...
            tablePackageMany.filed = [
                ...
                { "data": "LOAN_TYPE_NAME", "head": "贷款项目类型", "type": "td-keep" },
                { "data": "LOAN_YEAR_NAME", "head": "贷款项目学年", "type": "td-keep" },
				{ "data": "LOAN_NAME", "head": "贷款项目名称", "type": "td-keep" },
				{ "data": "LOAN_INFO", "head": "贷款项目说明", "type": "td-keep" },
            ...
            mainList = tablePackageMany.createOne({
                ...
                hasAjax: {
                    type: "server",
                    url: "/AdminLTE_Mod/BDM/Loan/ProjectSet/List.aspx?optype=getlist&from_page=check_basic",
                    method: "POST"
                },
                //表格参数
                attrs: {
                ...
                hasSearch: {
                    "cols": [
                        { "data": "LOAN_TYPE", "pre": "贷款项目类型", "col": 1, "type": "select", "ddl_name": "ddl_loan_type" },
                    	{ "data": "LOAN_YEAR", "pre": "贷款项目学年", "col": 2, "type": "select", "ddl_name": "ddl_year_type", "d_value": "<%=sch_info.CURRENT_YEAR %>" },
						{ "data": "LOAN_NAME", "pre": "贷款项目名称", "col": 3, "type": "input" }
				    ]
                },
                ...
                if (data) {
                    if (data.OID) {
                        if (data.CHECK_NOTICE_ID) {
                            ...
                            _form_notice.reset();
                            $("#hidNOTICE_OID").val("");
                            $("#TITLE").val("<" + data.LOAN_NAME + ">贷款项目开始进行核对");
    ...
    <script type="text/javascript">
        ...
        function loadModalPageDataInit() {
            ControlUtils.Input_SetDisableStatus("LOAN_NAME", true);
            ControlUtils.Input_SetDisableStatus("LOAN_TYPE_NAME", true);
            ControlUtils.Input_SetDisableStatus("LOAN_YEAR_NAME", true);
        ...
        function SendNoticeData() {
            ...
            if (data) {
                if (data.OID) {
                    ...
                    $.post(OptimizeUtils.FormatUrl("/AdminLTE_Mod/BDM/Notice/List.aspx?optype=save&loan_check_oid=" + data.OID), $("#form_notice").serialize(), function (msg) {
                        if (msg.length != 0) {
                            //$('.maskBg').hide();
                            //ZENG.msgbox.hide();
                            layer.close(layInx);
