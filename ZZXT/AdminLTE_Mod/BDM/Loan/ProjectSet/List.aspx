<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AltMaster.Master" AutoEventWireup="true"
    CodeBehind="List.aspx.cs" Inherits="PorteffAnaly.Web.AdminLTE_Mod.BDM.Loan.ProjectSet.List" %>
    ...
    <div class="modal" id="tableModal">
        <div class="modal-dialog modal-dw60">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">贷款项目设置</h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label class="col-sm-2 control-label">
                        贷款项目类型<span style="color: Red;">*</span></label>
                    <div class="col-sm-4">
                    ...
                    <label class="col-sm-2 control-label">
                        贷款项目学年<span style="color: Red;">*</span></label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">
                        贷款项目名称<span style="color: Red;">*</span></label>
                    <div class="col-sm-10">
                        <input name="LOAN_NAME" id="LOAN_NAME" type="text" class="form-control" placeholder="贷款项目名称" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">
                        贷款项目说明</label>
                    <div class="col-sm-10">
                        <textarea id="LOAN_INFO" name="LOAN_INFO" class="form-control" rows="3"></textarea>
                    </div>
                </div>
            </div>
        ...
        function loadModalBtnInit() {
            ...
            $dataModal.controls({
                ...
                "valiConfig": {
                    ...
                    validate: [
                        { 'name': 'LOAN_TYPE', 'tips': '贷款项目类型必须填' },
                    	{ 'name': 'LOAN_YEAR', 'tips': '贷款项目学年必须填' },
						{ 'name': 'LOAN_NAME', 'tips': '贷款项目名称必须填' }
					],
