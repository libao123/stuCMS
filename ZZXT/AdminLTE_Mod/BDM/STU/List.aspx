    ...
    <div class="modal fade" id="tableModal">
        <div class="modal-dialog modal-dw70">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">学生基本信息录入</h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label class="col-sm-2 control-label">学号<span style="color: Red;">*</span></label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">是否走读</label>
                    <div class="col-sm-4">
                        <input name="STUWORK" id="STUWORK" type="text" class="form-control" placeholder="是否走读" />
                    </div>

                    <label class="col-sm-2 control-label">学生类别<span style="color: Red;">*</span></label>
                    <div class="col-sm-4">
                        <select id="STUTYPE" name="STUTYPE" class="form-control" ddl_name='ddl_basic_stu_type' d_value='' title="学生类别" show_type="t">
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">入学方式<span style="color: Red;">*</span></label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">带班辅导员</label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-2 control-label">QQ号码<span style="color: Red;">*</span></label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <select id="SEX" name="SEX" class="form-control" ddl_name='ddl_xb' d_value='' title="性别" show_type="t">
                        </select>
                    </div>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">年级<span style="color: Red;">*</span></label>
                    <div class="col-sm-4">
                        <select id="EDULENTH" name="EDULENTH" class="form-control" ddl_name='ddl_grade' d_value='' title="年级" show_type="t">
                        </select>
                    </div>

                    <label class="col-sm-2 control-label">学院<span style="color: Red;">*</span></label>
                    <div class="col-sm-4">
                        <select id="COLLEGE" name="COLLEGE" class="form-control" ddl_name='ddl_department' d_value='' title="学院" show_type="t">
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <select id="POLISTATUS" name="POLISTATUS" class="form-control" ddl_name='ddl_zzmm' d_value='' title="政治面貌" show_type="t">
                        </select>
                    </div>

                    <label class="col-sm-2 control-label">专业<span style="color: Red;">*</span></label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">民族<span style="color: Red;">*</span></label>
                    <div class="col-sm-4">
                        <select id="NATION" name="NATION" class="form-control" ddl_name='ddl_mz' d_value='' title="民族" show_type="t">
                        </select>
                    </div>

                    <label class="col-sm-2 control-label">班级<span style="color: Red;">*</span></label>
                    <div class="col-sm-4">
                        <select id="CLASS" name="CLASS" class="form-control" ddl_name='ddl_class' d_value='' title="班级" show_type="t">
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">家庭所在地</label>
                    <div class="col-sm-4">
                        <input name="ADDRESS" id="ADDRESS" type="text" class="form-control" placeholder="家庭所在地" />
                    </div>

                    <label class="col-sm-2 control-label">户口所在地</label>
                    <div class="col-sm-4">
                        <input name="REGISTPLACE" id="REGISTPLACE" type="text" class="form-control" placeholder="户口所在地" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">考生类别</label>
                    <div class="col-sm-4">
        ...
        <div class="modal-dialog">
          <form id="form_import" name="form_edit" class="modal-content form-horizontal">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span></button>
                <h4 class="modal-title">学生基本信息批量导入</h4>
            </div>
            <div class="modal-body">

                <iframe id="importFrame" frameborder="0" src=""style="width: 100%; height: 250px; display:block;"></iframe>
