<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AltMaster.Master" AutoEventWireup="true"
    CodeBehind="BackCheck.aspx.cs" Inherits="PorteffAnaly.Web.AdminLTE_Mod.BDM.Insur.ProjectCheck.BackCheck" %>
    ...
    <script type="text/javascript">
        ...
        function loadTableList() {
            ...
            tablePackageMany.filed = [
                    ...
                    { "data": "OLD_INSUR_LIMITDATE", "head": "核对前承保期限", "type": "td-keep" },
                    { "data": "NEW_INSUR_LIMITDATE", "head": "核对后承保期限", "type": "td-keep" },
                    { "data": "OLD_INSUR_MONEY", "head": "核对前金额", "type": "td-keep" },
                    { "data": "NEW_INSUR_MONEY", "head": "核对后金额", "type": "td-keep" },
            ...
            mainList = tablePackageMany.createOne({
                ...
                hasSearch: {
                    "cols": [
                        ...
                        { "data": "CHECK_STEP", "pre": "核对阶段", "col": 8, "type": "select", "ddl_name": "ddl_apply_check_step" }
				    ]
                },
