            ...
            <div class="modal-body clearfix">
                <div class="col-xs-12">
                    ...
                    <div class="form-group">
                        <div class=" col-sm-6">
                            <label class="col-sm-4 control-label" style="padding-left: 5px; padding-right: 5px">
                                入校工作时间<span style="color: Red;">*</span></label>
                            <div class="col-sm-8" style="position: relative; z-index: 9999">
                    ...
                    <div class="form-group">
                        <div class=" col-sm-6">
                            <label class="col-sm-4 control-label">
                                移动电话<span style="color: Red;">*</span></label>
                            <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <div class=" col-sm-6">
                            <label class="col-sm-4 control-label">
                                办公电话<span style="color: Red;">*</span></label>
                            <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <div class="col-sm-6">
                            <label class="col-sm-4 control-label">
                                专兼职<span style="color: Red;">*</span></label>
                            <div class="col-sm-8">
        ...
        function loadTableList() {
            ...
            tablePackage.createOne({
                ...
                hasBtns: ["reload","edit", "del",
                    ...
                    { type: "userDefined", id: "export", title: "导出", className: "btn-info", attr: { "data-action": "", "data-other": "nothing"} }
				], //需要的按钮
                hasCtrl: {
                    "buildModal": false
                }
            ...
            $(document).on("click", "button[data-action='import']", function () {
                $("#importFrame").attr("src", '/Excel/ImportExcel/ImportExcel.aspx?model_id=importModal&type=INPUT_COUN');
                $("#importModal").modal();
            });
        }
    </script>
    <script type="text/javascript">
        ...
        function loadModalBtnInit() {
            ...
            $dataModal.controls({
                ...
                "valiConfig": {
                    ...
                    validate: [
                        ...
                        { 'name': 'OFFICEPHONE', 'tips': '办公电话必须填' },
                        { 'name': 'PORJOB', 'tips': '专兼职必须填' }
					],
            ...
            _content.on('click', "#export", function () {
                window.open('/Excel/ExportExcel/ExportExcel.aspx?optype=coun_list' + GetSearchUrlParam());
            });
        }
        //保存事件
        function SaveData() {
        ...
        function GetSearchUrlParam() {
            var ENO = DropDownUtils.getDropDownValue("search-ENO");
            var NAME = DropDownUtils.getDropDownValue("search-NAME");
            var DEPARTMENT = DropDownUtils.getDropDownValue("search-DEPARTMENT");
            var IDCARDNO = DropDownUtils.getDropDownValue("search-IDCARDNO");

            var strq = "";
            if (ENO)
                strq += "&ENO=" + OptimizeUtils.FormatParamter(ENO);
            if (NAME)
                strq += "&NAME=" + OptimizeUtils.FormatParamter(NAME);
            if (IDCARDNO)
                strq += "&IDCARDNO=" + OptimizeUtils.FormatParamter(IDCARDNO);
            if (DEPARTMENT)
                strq += "&DEPARTMENT=" + DEPARTMENT;
            return strq;
        }
