        ...
        <div class="modal-dialog modal-dw60">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label class="col-sm-4 control-label">单位代码<span style="color: Red;">*</span></label>
                    <div class="col-sm-8">
                        <input name="DW" id="DW" type="text" class="form-control" placeholder="单位代码" maxlength="10" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-4 control-label">单位名称<span style="color: Red;">*</span></label>
                    <div class="col-sm-8">
                        <input name="MC" id="MC" type="text" class="form-control" placeholder="单位名称" maxlength="50" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-4 control-label">单位类型<span style="color: Red;">*</span></label>
                    <div class="col-sm-8">
