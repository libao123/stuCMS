<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AltMaster.Master" AutoEventWireup="true"
    CodeBehind="PorceLogList.aspx.cs" Inherits="PorteffAnaly.Web.AdminLTE_Mod.APP.LogManage.PorceLogList" %>
    ...
    <script type="text/javascript">
        ...
        function loadTableList() {
            ...
            tablePackage.filed = [
				...
				{ "data": "LOG_TYPE", "head": "日志类型", "type": "td-keep" },
				{ "data": "LOG_TIME", "head": "记录时间", "type": "td-keep" },
				{ "data": 'LOG_MSG', "head": '日志内容', "type": "td-keep" }
			];
            ...
            tablePackage.createOne({
                ...
                hasAjax: {
                    type: "server",
                    url: "PorceLogList.aspx?optype=getlist",
                    method: "POST"
                },
                //表格参数
                attrs: {
                ...
                hasSearch: {
                    "cols": [
						{ "data": "LOG_TYPE", "pre": "日志类型", "col": 1, "type": "select", "ddl_name": "ddl_log_level" },
                        { "data": "LOG_MSG", "pre": "日志内容", "col": 1, "type": "input" },
						{ "data": "LOG_TIME", "pre": "日志记录时间", "col": 2, "type": "timeSingle" },
						{ "data": "LOG_TIME2", "pre": "至", "col": 3, "type": "timeSingle" },
					]
                },
