	...
	createOne:	function(sData){
		...
		$table.init = function(){
			...
			dataConfig['initComplete'] = function(){
					...
					//checkbox全选
					$("#"+property.buttonId).on("click", ".btn-clearData", function(){
						var _ts = $(this);
					...
					// $("#" + property.tableId).find('tr').eq(2).css({"background":"red"});
					// elo.disabledLine(2);
					// elo.disabledLine(2);
			    // elo.changeLine(3, "#654321");
					
					// if(sData['disableArr'] != undefined && sData.hasOwnProperty('disableArr')){
					// 	console.log(sData['disableArr']);
					// 	var _dAr = sData['disableArr'];
					// 	for (var i = 0; i < _dAr.length; i++) {
					// 		var _dE = _dAr[i];
					// 		elo.disabledLine(_dE);
					// 	}
					// }
					// if(sData['changeArr'] != undefined && sData.hasOwnProperty('changeArr')){
					// 	console.log(sData['changeArr']);
					// 	var _cAr = sData['changeArr'];
					// 	for (var i = 0; i < _cAr.length; i++) {
					// 		var _cE = _cAr[i];
					// 		console.log(_cE.row);
					// 		elo.changeLine(_cE.row, _cE.color);
					// 	}
					// }
			}
			// console.log(dataConfig);
