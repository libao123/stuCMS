    ...
    <div class="modal" id="tableModal">
        <div class="modal-dialog" style="width: 60%">
                    ...
                    <div class="box-body with-border">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">
                                信息类型</label>
                            <div class="col-sm-10">
                                <select class="form-control" name="MSG_TYPE" id="MSG_TYPE" d_value='' ddl_name='ddl_msg_type'
                                    show_type='t' style="margin: 0;">
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-12">
                                <textarea name="MSG_CONTENT" id="MSG_CONTENT" cols="10" rows="5" class="form-control"
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-save" id="btnDel">
                    删除接收人</button>
                <button type="button" class="btn btn-primary btn-save" id="btnAdd">
                    新增接收人</button>
