<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="List.aspx.cs" Inherits="PorteffAnaly.Web.SysBasic.zd_xsh.List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            MiscUtils.onlyNumAlpha("DM"); //代码限制只能录入数字或者字母
            ...
            //其他显示的列
            var cols = [[
             { field: 'DM', title: '代码', width: 100, sortable: true },
            ...
            var tBar = [{
                ...
                iconCls: 'icon-cancel',
                handler: function () {
                    DialogUtils.showDeleteDataDialog("tabList", "List.aspx?optype=delete", "是否删除该系所信息数据？", "DM");
                    ClearValue();
                }
            }, '-', {
                text: '保存',
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    ...
    <fieldset class="fieldsetclass">
        <legend class="legendclass">编辑系所信息</legend>
        <div id="content" style="width: 100%;">
            <table class="form-tb" style="width: 95%; margin: 10px;">
                <tr>
                    <td class="label-bg" style="width: 80px;">
                        系所代码<span style="color: Red;">*</span>
                    </td>
                    <td>
                        <input type="text" id="DM" name="DM" style="width: 220px;" class="easyui-validatebox input-text"
                            value="" required="true" maxlength="4" />
                    </td>
                    <td class="label-bg" style="width: 80px;">
                        系所名称<span style="color: Red;">*</span>
                    </td>
                    <td>
                        <input type="text" id="MC" name="MC" style="width: 220px;" class="easyui-validatebox input-text"
                            value="" required="true" maxlength="10" />
                    </td>
                </tr>
                <tr>
                    <td class="label-bg" style="width: 80px;">
    ...
    <fieldset class="fieldsetclass">
        <legend class="legendclass">字典系所信息</legend>
