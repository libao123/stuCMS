  ...
  <div id="menuFrame" class="content-wrapper" id="main-container">
	...
	<script type="text/javascript">
		...
		var tableModalCols = [//弹出层布局label+form<=12，
			{ "data": "NOTICE_TYPE", "head":"信息类型", 'label': '4', 'form': '8', 'parent': '12' },
			{ "data": "TITLE", "head":"标题", 'label': '4', 'form': '8', 'parent': '12' },
			{ "data": "START_TIME", "head":"信息有效开始时间", 'label': '4', 'form': '8', 'parent': '12', 'type':'timeSingle' },
			{ "data": "END_TIME", "head":"信息有效结束时间", 'label': '4', 'form': '8', 'parent': '12', 'type': 'timeSingle' },
			{ "data": "ROLEID", "head":"可查阅角色", 'label': '4', 'form': '8', 'parent': '12'},//type timeRange
			{ "data": "SEND_NAME", "head":"发布人", 'label': '4', 'form': '8', 'parent': '12'},
			{ "data": "SEND_TIME", "head":"发布时间", 'label': '4', 'form': '8', 'parent': '12', 'type': 'timeSingle'},
		];
		...
		var modalConfigs = {//弹出层配置
			...
			"title":		"公共信息管理",//弹出层标题
			"delCol":		["NOTICE_TYPE","TITLE",],//删除所需字段
			"delAction":	'List.aspx?optype=delete',//删除url
			"modalAction":	'Edit.aspx?optype=modi',//弹出层url
			"modalSuccess":_callback,
			"struct":		[//构造弹出层
