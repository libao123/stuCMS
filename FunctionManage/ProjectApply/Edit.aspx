...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    <!-- 编辑界面 开始  form-inline-->
    <div class="modal-content form-horizontal" id="editDiv">
          ...
          <div id="" class="box box-default" style="border: none; margin: 0;">
            ...
            <div class="nav-tabs-custom" style="box-shadow: none; margin-bottom: 0px;">
                <ul class="nav nav-tabs">
                    ...
                    <li id="tab_approveinfo"><a href="#tab_6" data-toggle="tab">评审情况</a></li>
                </ul>
                <div class="tab-content row">
                    ...
                    <div class="tab-pane active" id="tab_1">
                        ...
                        <div class="box-body" id="div_ProjectInfo">
                            ...
                            <div class="form-group">
                              <div class="col-sm-6">
                                <label class="col-sm-4 control-label">项目学年</label>
                                <div class="col-sm-8">
                        ...
                        <!-- <div class="form-horizontal box-body" id="div_StudentInfo">
                            <div class="form-group col-sm-6">
                                <label class="col-sm-4 control-label">
                                    学号</label>
                                <div class="col-sm-8">
                        ...
                        <div class="box-body" id="div_StudentInfo">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <label class="col-sm-4 control-label">学制</label>
                                <div class="col-sm-8">
                                    <input name="SYSTEM" id="SYSTEM" type="text" class="form-control" placeholder="学制" />
                                </div>
                            </div>
                        ...
                        <!-- <div class="form-horizontal box-body" id="div_ProjectApplyInfo">
                            <div class="form-group col-sm-12" id="div_POST_INFO">
                                <label class="col-sm-2 control-label">
                                    曾/现任职情况</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group col-sm-6" id="div_REWARD_FLAG">
                                <label class="col-sm-4 control-label">
                                    拟评何种类型</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group col-sm-6" id="div_TRAIN_TYPE">
                                <label class="col-sm-4 control-label">
                                    培养方式</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group col-sm-6" id="div_HARD_FOR">
                                <label class="col-sm-4 control-label">
                                    攻读学位</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group col-sm-12" id="div_BASIC_UNIT">
                                <label class="col-sm-2 control-label">
                                    基层单位</label>
                                <div class="col-sm-10">
                        ...
                        <div class="box-body" id="div_ProjectApplyInfo">
                          ...
                          <div class="form-group">
                            <div class="col-sm-6" id="div_REWARD_FLAG">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" name="REWARD_FLAG" id="REWARD_FLAG" d_value='' ddl_name='<%=m_RewardFlag %>' show_type='t'>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-6" id="div_STUDY_LEVEL">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" name="STUDY_LEVEL" id="STUDY_LEVEL" d_value='' ddl_name='ddl_apply_study_level' show_type='t'>
                                    </select>
                                </div>
                            </div>
                          </div>
                        ...
                        <div class="box-header with-border" id="div_title_APPLY_REASON">
                            <h3 class="box-title">
                                <label id="lab_txt_APPLY_REASON">申请理由</label><label id="lab_showmsg_APPLY_REASON"></label></h3>
                        </div>
                        <!-- <div class="form-horizontal box-body" id="div_APPLY_REASON">
                            <div class="form-group col-sm-12">
                                <div class="col-sm-12">
                        ...
                        <div class="box-header with-border" id="div_title_PUBLISH_INFO">
                            <h3 class="box-title"><label>论文发表、获得专利等情况</label></h3>
                        </div>
                    ...
                    <div class="tab-pane" id="tab_2">
                        <div class="box-header with-border">
                            <h3 class="box-title">
                                家庭基本信息</h3>
                            <button type="button" class="btn btn-danger" id="update_familymember">
                                同步数据</button>
                        </div>
                    ...
                    <div class="tab-pane" id="tab_4">
                        <div class="box-header with-border">
                            <h3 class="box-title">
                                上学年度综合考评成绩</h3>
                            <button type="button" class="btn btn-danger" id="update_study">
                                同步数据</button>
                        </div>
                        <div class="form-horizontal box-body">
                            <div class="form-group col-sm-6" id="div_SCORE_RANK">
                                <label class="col-sm-4 control-label">
                                    成绩排名：名次</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group col-sm-6" id="div_SCORE_TOTAL_NUM">
                                <label class="col-sm-4 control-label">
                                    总人数</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group col-sm-6" id="div_MUST_COURSE_NUM">
                                <label class="col-sm-4 control-label">
                                    必修课 / 门</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group col-sm-6" id="div_PASS_COURSE_NUM">
                                <label class="col-sm-4 control-label">
                                    其中及格以上 / 门</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group col-sm-6" id="div_IS_SCORE_FLAG">
                                <label class="col-sm-4 control-label">
                                    是否实行综合考试排名</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group col-sm-6" id="div_COM_SCORE">
                                <label class="col-sm-4 control-label">
                                    个人达标综合考评成绩</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group col-sm-6" id="div_COM_SCORE_RANK">
                                <label class="col-sm-4 control-label">
                                    综合考评排名：名次</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group col-sm-6" id="div_COM_SCORE_TOTAL_NUM">
                                <label class="col-sm-4 control-label">
                                    总人数</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group col-sm-6" id="div_PREYEAR_SCORE">
                                <label class="col-sm-4 control-label">
                                    学年平均成绩</label>
                                <div class="col-sm-8">
                    ...
                    <div class="tab-pane" id="tab_5">
                        <div class="box-header with-border">
                            <h3 class="box-title">人生格言<label id="lab_showmsg_MOTTO"></label></h3>
                        </div>
                        <div class="box-body">
                          <div class="form-group">
                              <div class="col-sm-12">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">师长点评<label id="lab_showmsg_TEACHER_INFO"></label></h3>
                        </div>
                        <div class="box-body">
                          <div class="form-group">
                              <div class="col-sm-12">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">事迹正文<label id="lab_showmsg_MODEL_INFO"></label></h3>
                        </div>
                        <div class="box-body">
                          <div class="form-group">
                              <div class="col-sm-12">
                    ...
                    <div class="tab-pane" id="tab_6">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">班级民主评议小组意见</h3>
                        </div>
                        <div class="box-body">
                          <div class="form-group">
                            <div class="col-sm-12">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-primary btn-save" id="btnApprove">
                审批</button>
    ...
    <!-- 编辑界面 结束-->
    <!-- 家庭成员编辑界面 开始 -->
    <div class="modal" id="tableModal_FamilyMember">
        <div class="modal-dialog">
            <form action="#" method="post" id="form_familymember" name="form_familymember" class="modal-content form-horizontal form-inline"
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-save" id="btnsave_familymember">
                    保存</button>
    ...
    <!-- 家庭成员编辑界面 结束-->
    <!-- 学习情况编辑界面 开始 -->
    <div class="modal" id="tableModal_StudyList">
        <div class="modal-dialog">
            <form action="#" method="post" id="form_studylist" name="form_studylist" class="modal-content form-horizontal form-inline"
            onsubmit="return false;">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span></button>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-save" id="btnsave_studylist">
                    保存</button>
                <button type="button" class="btn btn-default pull-left" data-dismiss="modal">
                    关闭</button>
            </div>
    ...
    <!-- 学习情况编辑界面 结束-->
    <!-- 获奖情况编辑界面 开始 -->
    <div class="modal" id="tableModal_Reward">
        <div class="modal-dialog">
            <form action="#" method="post" id="form_reward" name="form_reward" class="modal-content form-horizontal form-inline"
            onsubmit="return false;">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span></button>
            ...
            <div class="modal-body row">
                <input type="hidden" id="hidOid_Rewad" name="hidOid_Rewad" value="" />
                <input type="hidden" id="hidSeqNo_Rewad" name="hidSeqNo_Rewad" value="" />
                <div class="form-group col-sm-12">
                    <label class="col-sm-2 control-label">
                ...
                <div class="form-group col-sm-6">
                    <label class="col-sm-4 control-label">
                        获奖日期<span style="color: red">*</span></label>
                    <div class="col-sm-8" style="position: relative; z-index: 9999">
                        <input name="REWARD_DATE" id="REWARD_DATE" type="text" class="form-control datep"
                            placeholder="获奖日期" />
                    </div>
                </div>
                <div class="form-group col-sm-6">
                    <label class="col-sm-4 control-label">
                        奖项等级<span style="color: red">*</span></label>
                    <div class="col-sm-8">
                        <input name="REWARD_LEVEL" id="REWARD_LEVEL" type="text" class="form-control" placeholder="获奖等级" />
                    </div>
                </div>
                <div class="form-group col-sm-6">
                    <label class="col-sm-4 control-label">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-save" id="btnsave_reward">
                    保存</button>
            </div>
            </form>
            <form id="form_reward_file" name="form_reward_file" class="modal-content form-horizontal form-inline"
            runat="server">
            <input type="hidden" id="hidOid_Rewad_ForUpload" name="hidOid_Rewad_ForUpload" value=""
                runat="server" />
            <div class="modal-body row">
                <div class="form-group col-sm-12">
                    <label class="col-sm-2 control-label">
                    ...
                    <div class="col-sm-10">
                        <input id="fileUpload" name="fileUpload" type="file" multiple="multiple" runat="server"
                            onchange="CheckFileType (this,'REPORT_FILE');" />
                    </div>
                </div>
                <div class="form-group col-sm-12">
                    <label class="col-sm-2 control-label">
                        附件名称</label>
                    <div class="col-sm-10">
                        <input name="REPORT_FILE" id="REPORT_FILE" type="text" class="form-control" placeholder="附件名称" />
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-save" id="btnsearch_reward">
                    查看附件</button>
                <asp:LinkButton ID="fileUploadBtn" runat="server" class="btn btn-primary btn-save"
                    OnClientClick="ChkIsUpload();" OnClick="fileUpload_Click">上传附件</asp:LinkButton>
                <button type="button" class="btn btn-default pull-left" data-dismiss="modal">
                    关闭</button>
            </div>
            </form>
    ...
    <!-- 获奖情况编辑界面 结束-->
    <!-- 审核界面 开始 -->
    <div class="modal" id="tableModal_Approve">
        <div class="modal-dialog">
            <form action="#" method="post" id="form_approve" name="form_approve" class="modal-content form-horizontal form-inline"
            onsubmit="return false;">
            ...
            <div class="form-group col-sm-12" id="div_approveMsg">
                <label class="col-sm-4 control-label" id="lab_approveMsg">
            ...
            <div class="form-group col-sm-12" id="div_comMsg">
                <label class="col-sm-4 control-label" id="lab_comMsg">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default pull-left" data-dismiss="modal">
                    关闭</button>
                <button type="button" class="btn btn-primary btn-save" id="btnSubmitApprove">
                    确认</button>
            </div>
            </form>
        </div>
    ...
    <script type="text/javascript">
        function loadTableList_Reward() {
            ...
            tablePackageMany.filed = [
				    ...
				    { "data": "REWARD_DATE", "head": "获奖日期", "type": "td-keep" },
				    { "data": "REWARD_LEVEL", "head": "奖项等级", "type": "td-keep" },
				    { "data": "REWARD_TYPE_NAME", "head": "奖项类型", "type": "td-keep" },
                    { "data": "AWARD_DEPARTMENT", "head": "颁奖单位", "type": "td-keep" },
                    { "data": "REPORT_FILE", "head": "附件名称", "type": "td-keep" }
		    ];
            ...
            rewardList = tablePackageMany.createOne({
                ...
                //info(蓝色)  primary(深蓝)  success(绿色)  danger(红色)
                hasBtns: [
                { type: "userDefined", id: "searchfile_reward", title: "查看附件", className: "btn-danger", attr: { "data-action": "", "data-other": "nothing"} },
                <%if(!IsView) {%>
    ...
    <script type="text/javascript">
        ...
        function loadModalBtnInit() {
            ...
            //【查看附件】
            _editDiv.on('click', "#searchfile_reward", function () {
                var data = rewardList.selectSingle();
                if (data) {
                    if (data.OID) {
                        if (data.REPORT_FILE_NAME.length == 0) {
                            easyAlert.timeShow({
                                "content": "未上传附件！",
                                "duration": 2,
                                "type": "danger"
                        ...
                        var url = AjaxUtils.getResponseText("RewardInfo.aspx?optype=download&id=" + data.OID);
                        window.open(url);
                    }
                }
            });
            ...
            //【查看附件】
            _tableModal_Reward.on('click', "#btnsearch_reward", function () {
                var data = rewardList.selectSingle();
                if (data) {
                    if (data.OID) {
                        if (data.REPORT_FILE_NAME.length == 0) {
    ...
    <script type="text/javascript">
        function loadModalPageValidate() {
            ...
            ValidateUtils.setRequired("#form_reward", "REWARD_DATE", true, "获奖日期必填");
            ValidateUtils.setRequired("#form_reward", "REWARD_LEVEL", true, "奖项等级必填");
    ...
    <script type="text/javascript">
        ...
        function ByOpTypeLoadEditPageData() {
            ...
            || '<%=Request.QueryString["optype"] %>' == 'view') {//查阅
                ...
                $("#hidSeqNo_Rewad").val('<%=Request.QueryString["seq_no"] %>');
                //表头
        ...
        function HideBtn(optype) {
            if (optype == 'view') {
                ...
                $("#btnSubmit").show();
                //家庭信息
                $("#add_familymember").show();
                $("#edit_familymember").show();
                $("#del_familymember").show();
        ...
        function SetDisable() {
            ...
            _tab_6 = PageValueControl.init("tab_6");
        ...
        function SaveData() {
            ...
            $.post(OptimizeUtils.FormatUrl("Edit.aspx?optype=save"), $("#form_edit").serialize(), function (msg) {
                if (msg.length == 0) {
                    ...
                    $("#hidSeqNo_Rewad").val(msg_json.SEQ_NO);
        ...
        function ChkIsUpload() {
            ...
            if (data) {
                if (data.OID) {
                    //是否已经选择了上传文件
                    if ($('#REPORT_FILE').val().length == 0) {
                        easyAlert.timeShow({
                            "content": "请选择获奖证书附件再进行上传！",
                            "duration": 2,
                            "type": "info"
                        });
                        return;
                    }
                    $("#<%=hidOid_Rewad_ForUpload.ClientID %>").val(data.OID);
                }
                else {
                    easyAlert.timeShow({
                        "content": "请先保存再上传相应奖项附件！",
                        "duration": 2,
                        "type": "info"
                    });
                    return;
    ...
    <script type="text/javascript">
        function LoadPageSet(projectType) {
            ...
            LoadPageSet_19_20_21(projectType);
    ...
    <script type="text/javascript">
        function LoadPageSet_19_20_21(projectType) {
            if (projectType == "COUNTRY_YP"
            || projectType == "COUNTRY_STUDY"
