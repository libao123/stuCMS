<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AltMaster.Master" AutoEventWireup="true" CodeBehind="List_pend.aspx.cs" 
    Inherits="PorteffAnaly.Web.AdminLTE_QZ.JobProof.List_pend" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
        ...
        <div class="modal-dialog" style="width: 70%;">
            <form action="#" method="post" id="form_edit" name="form_edit" class="modal-content form-horizontal form-inline"
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">劳酬审核--待处理</h4>
                </div>
    ...
    <script type="text/javascript">
            ...
            _content.on('click', '#btn-view', function () {
                ...
                if (data) {
                    ...
                    if (apply_data) {
                        ...
                        if (apply_data_json.CMPL_STS && apply_data_json.CMPL_STS == apply_data_json.CMPL_STS_TEXT) {
                            $("#CMPL_STS").val("O");
                ...
                control: {
                    ...
                    "beforeShow": function (btn, form) {//返回btn信息和form信息
                        ...
                        if (data) {
                            if (data.OID) {
                                //劳动完成情况
                                if ("<%=user.User_Role%>" == "D" && !SaveCompleteStatus())
                                    return false;
        ...
        function SaveCompleteStatus() {
            ...
            if ($("#CMPL_STS").val() == "O" && $("#CMPL_STS_TEXT").val() == "") {
                easyAlert.timeShow({
                    "content": "劳动完成情况选择[其他]时，请手动填写！",
                    "duration": 3,
                    "type": "danger"
                });
                return false;
            ...
            $.post(OptimizeUtils.FormatUrl("?optype=savests"), data, function (msg) {
                if (msg.length == 0) {
                    easyAlert.timeShow({
                        "content": "保存劳动完成情况失败！",
                        "duration": 2,
