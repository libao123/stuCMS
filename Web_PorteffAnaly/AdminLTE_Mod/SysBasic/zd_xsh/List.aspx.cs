...
namespace PorteffAnaly.Web.AdminLTE_Mod.SysBasic.zd_xsh
{
	public partial class List : ListBaseLoad<T_zd_xsh>
	{
		#region 初始化
		...
		protected override SelectTransaction<T_zd_xsh> GetSelectTransaction()
		{
			return ImplementFactory.GetSelectTransaction<T_zd_xsh>("T_zd_xshSelectTransaction", param);
		}
		...
		protected override IEnumerable<NameValue> GetValue(T_zd_xsh entity)
		{
