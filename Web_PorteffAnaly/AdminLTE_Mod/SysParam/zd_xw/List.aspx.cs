...
namespace PorteffAnaly.Web.AdminLTE_Mod.SysParam.zd_xw
{
    public partial class List : ListBaseLoad<T_zd_xw>
    {
        #region 初始化
        ...
        protected override SelectTransaction<T_zd_xw> GetSelectTransaction()
        {
            return ImplementFactory.GetSelectTransaction<T_zd_xw>("T_zd_xwSelectTransaction", param);
        }
        ...
        protected override IEnumerable<ListBaseLoad<T_zd_xw>.NameValue> GetValue(T_zd_xw entity)
        {
        ...
        private string DeleteData()
        {
            if (string.IsNullOrEmpty(Get("id")))
                return "编码为空,不允许删除操作";
            T_zd_xw head = new T_zd_xw();
            head.DM = Get("id");
            ds.RetrieveObject(head);
            var transaction = ImplementFactory.GetDeleteTransaction<T_zd_xw>("T_zd_xwDeleteTransaction");
