...
namespace PorteffAnaly.Web.AdminLTE_Mod.SysParam.zd_zjlx
{
    public partial class List : ListBaseLoad<T_zd_zjlx>
    {
        #region 初始化
        ...
        protected override SelectTransaction<T_zd_zjlx> GetSelectTransaction()
        {
            return ImplementFactory.GetSelectTransaction<T_zd_zjlx>("T_zd_zjlxSelectTransaction", param);
        }
        ...
        protected override IEnumerable<ListBaseLoad<T_zd_zjlx>.NameValue> GetValue(T_zd_zjlx entity)
        {
        ...
        private string DeleteData()
        {
            if (string.IsNullOrEmpty(Get("id")))
                return "编码为空,不允许删除操作";
            T_zd_zjlx head = new T_zd_zjlx();
            head.DM = Get("id");
            ds.RetrieveObject(head);
            var transaction = ImplementFactory.GetDeleteTransaction<T_zd_zjlx>("T_zd_zjlxDeleteTransaction");
