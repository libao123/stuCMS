...
namespace PorteffAnaly.Web.AdminLTE_Mod.SysParam.zd_rxfs
{
    public partial class List : ListBaseLoad<T_zd_rxfs>
    {
        #region 初始化
        ...
        protected override SelectTransaction<T_zd_rxfs> GetSelectTransaction()
        {
            return ImplementFactory.GetSelectTransaction<T_zd_rxfs>("T_zd_rxfsSelectTransaction", param);
        }
        ...
        protected override IEnumerable<ListBaseLoad<T_zd_rxfs>.NameValue> GetValue(T_zd_rxfs entity)
        {
        ...
        private string DeleteData()
        {
            if (string.IsNullOrEmpty(Get("id")))
                return "编码为空,不允许删除操作";
            T_zd_rxfs head = new T_zd_rxfs();
            head.DM = Get("id");
            ds.RetrieveObject(head);
            var transaction = ImplementFactory.GetDeleteTransaction<T_zd_rxfs>("T_zd_rxfsDeleteTransaction");
