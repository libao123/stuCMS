<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AltMaster.Master" AutoEventWireup="true"
    CodeBehind="BasicList.aspx.cs" Inherits="PorteffAnaly.Web.AdminLTE_Mod.BDM.Insur.ProjectCheck.BasicList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">
                        项目类型</label>
                    <div class="col-sm-4">
                        <input name="INSUR_TYPE_NAME" id="INSUR_TYPE_NAME" type="text" class="form-control"
                            placeholder="项目类型" />
                    </div>
                    ...
                    <label class="col-sm-2 control-label">
                        项目学年</label>
                    <div class="col-sm-4">
                        <input name="INSUR_YEAR_NAME" id="INSUR_YEAR_NAME" type="text" class="form-control"
                            placeholder="项目学年" />
                    </div>
                </div>
                <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        function loadTableList() {
            ...
            mainList = tablePackageMany.createOne({
                ...
                hasAjax: {
                    type: "server",
                    url: "/AdminLTE_Mod/BDM/Insur/ProjectSet/List.aspx?optype=getlist&from_page=check_basic",
                    method: "POST"
                },
                //表格参数
                attrs: {
                ...
                if (data) {
                    if (data.OID) {
                        if (data.CHECK_NOTICE_ID) {
                            ...
                            _form_notice.reset();
                            $("#hidNOTICE_OID").val("");
                            $("#TITLE").val("<" + data.INSUR_NAME + ">保险项目开始进行核对");
    ...
    <script type="text/javascript">
        ...
        function loadModalPageDataInit() {
            ControlUtils.Input_SetDisableStatus("INSUR_NAME", true);
            ControlUtils.Input_SetDisableStatus("INSUR_TYPE_NAME", true);
            ControlUtils.Input_SetDisableStatus("INSUR_YEAR_NAME", true);
        ...
        function SendNoticeData() {
            ...
            if (data) {
                if (data.OID) {
                    ...
                    $.post(OptimizeUtils.FormatUrl("/AdminLTE_Mod/BDM/Notice/List.aspx?optype=save&insur_check_oid=" + data.OID), $("#form_notice").serialize(), function (msg) {
                        if (msg.length != 0) {
                            //$('.maskBg').hide();
                            //ZENG.msgbox.hide();
                            // layer.close(layInx);
