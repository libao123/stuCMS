<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AltMaster.Master" AutoEventWireup="true"
    CodeBehind="List.aspx.cs" Inherits="PorteffAnaly.Web.AdminLTE_Mod.BDM.Insur.ProjectResult.List" %>
    ...
    <script type="text/javascript">
        ...
        function loadTableList() {
            ...
            mainList = tablePackageMany.createOne({
                ...
                hasAjax: {
                    type: "server",
                    url: "/AdminLTE_Mod/BDM/Insur/ProjectApply/List.aspx?optype=getlist&page_from=personal",
                    method: "POST"
                },
                //表格参数
                attrs: {
                ...
                { type: "userDefined", id: "import", title: "导入参保信息", className: "btn-danger", attr: { "data-action": "", "data-other": "nothing"} },
    ...
    <script type="text/javascript">
        ...
        function loadModalBtnInit() {
            ...
            _content.on('click', "#import", function () {
                $("#importFrame").attr("src", '/Excel/ImportExcel/ImportExcel.aspx?model_id=importModal&type=INPUT_INSUR_RESULT');
                $("#importModal").modal();
            });
            //【查阅】
