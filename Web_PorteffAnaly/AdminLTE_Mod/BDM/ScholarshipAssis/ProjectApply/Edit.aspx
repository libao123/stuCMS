...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    <!-- 编辑界面 开始  form-inline-->
    <div class="modal fade in" id="editDiv" style="z-index: 1042; display: block; overflow-y: auto;">
        <div class="modal-dialog modal-dw100" style="margin: 0;">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" id="btnTopClose">
                                ...
                                <div class="box-header with-border" id="div_title_APPLY_REASON">
                                    <h3 class="box-title">
                                        <label id="lab_txt_APPLY_REASON">
                                            申请理由</label><label id="lab_showmsg_APPLY_REASON"></label></h3>
                                </div>
    ...
    <div class="modal fade" id="tableModal_FamilyMember">
        <div class="modal-dialog">
            <form action="#" method="post" id="form_familymember" name="form_familymember" class="modal-content form-horizontal"
            onsubmit="return false;">
            <div class="modal-header">
    ...
    <div class="modal fade" id="tableModal_StudyList">
        <div class="modal-dialog">
            <form action="#" method="post" id="form_studylist" name="form_studylist" class="modal-content form-horizontal"
            onsubmit="return false;">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span></button>
    ...
    <div class="modal fade" id="tableModal_Reward">
        <div class="modal-dialog modal-dw60">
            <form action="#" method="post" id="form_reward" name="form_reward" class="modal-content form-horizontal"
            onsubmit="return false;">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span></button>
    ...
    <div class="modal fade" id="tableModal_File">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                <iframe id="uploadFrame" frameborder="0" src="" style="width: 100%; height: 300px;">
                </iframe>
            </div>
            </form>
        </div>
    ...
    <div class="modal fade" id="tableModal_Approve">
        <div class="modal-dialog">
            <form action="#" method="post" id="form_approve" name="form_approve" class="modal-content form-horizontal"
            onsubmit="return false;">
    ...
    <!-- 审核界面 结束-->
    <!-- 上传附件材料说明 开始 -->
    <div class="modal" id="tableModal_RemarkFile">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="col-sm-12 control-label">
                        注意：要求拍摄原件，图片格式上传</label>
                </div>
                <div class="form-group">
                    <label class="col-sm-12 control-label">
                        1、参评学年课程成绩表（要求加盖教务处或学院公章）；</label>
                </div>
                <div class="form-group">
                    <label class="col-sm-12 control-label">
                        2、英语、计算机过级证书；</label>
                ...
                <div class="form-group">
                    <label class="col-sm-12 control-label">
                        3、其他与专业学习相关的资格等级证书；</label>
                </div>
                <div class="form-group">
                    <label class="col-sm-12 control-label">
                        4、省（区）级（含）以上与专业学习相关的获奖证书；</label>
                </div>
                <div class="form-group">
                    <label class="col-sm-12 control-label">
                        5、已公开发表的论文刊物或其他相关作品。</label>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default pull-left" data-dismiss="modal">
    ...
    <%--LIFE_LIFE：生活补贴类奖学金：无对应模板，数据自动生成形式--%>
    <script type="text/javascript">
        function LoadPageSet_life(projectType) {
            if (projectType == "LIFE_LIFE") {
                //******界面******************
                //--------基本信息 界面-------
                $("#div_REWARD_FLAG").hide(); //拟评何种类型
                $("#div_STUDY_LEVEL").hide(); //学习阶段
