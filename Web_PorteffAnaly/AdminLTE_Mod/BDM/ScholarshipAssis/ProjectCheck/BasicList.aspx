            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">
                        项目级别</label>
                    <div class="col-sm-4">
                        <input name="PROJECT_CLASS_NAME" id="PROJECT_CLASS_NAME" type="text" class="form-control"
                            placeholder="项目级别" />
                    </div>
                    <label class="col-sm-2 control-label">
                        申请表格类型</label>
                    <div class="col-sm-4">
                        <input name="PROJECT_TYPE_NAME" id="PROJECT_TYPE_NAME" type="text" class="form-control"
                            placeholder="申请表格类型" />
                    </div>
                </div>
                <div class="form-group">
