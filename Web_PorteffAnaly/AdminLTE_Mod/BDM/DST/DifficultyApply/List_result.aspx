<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AltMaster.Master" AutoEventWireup="true" 
    CodeBehind="List_result.aspx.cs" Inherits="PorteffAnaly.Web.AdminLTE_Mod.BDM.DST.DifficultyApply.List_result" %>
    ...
    <script type="text/javascript">
        ...
        function loadTableList() {
            ...
            mainList = tablePackageMany.createOne({
                ...
                hasSearch: {
                    "cols": [
						...
						{ "data": "IS_CHG_LVL", "pre": "是否修改等级", "col": 5, "type": "select", "ddl_name": "ddl_yes_no" }
                    ]
                },
            ...
            _content.on('click', "#btn-list-export", function () {
                ...
                var IS_CHG_LVL = DropDownUtils.getDropDownValue("search-IS_CHG_LVL");
                if (SCHYEAR.length == 0) {
                    easyAlert.timeShow({
                        "content": "查询条件：学年不能为空！",
                        "duration": 3,
                ...
                if (BATCH_NO.length == 0) {
                    easyAlert.timeShow({
                        "content": "查询条件：开放批次不能为空！",
                        "duration": 3,
                        "type": "info"
                    });
                    return;
                }
                if ('<%=user.User_Role%>' != 'X' && COLLEGE.length == 0) {
                    easyAlert.timeShow({
                        "content": "查询条件：学院不能为空！",
                        "duration": 3,
                        "type": "info"
                ...
                var para = '&SCHYEAR=' + SCHYEAR + '&COLLEGE=' + COLLEGE + '&CLASS=' + CLASS + '&MAJOR=' + MAJOR + '&LEVEL_CODE=' + LEVEL_CODE + '&NAME=' + NAME + '&DECLARE_TYPE=' + DECLARE_TYPE + '&BATCH_NO=' + BATCH_NO + '&IS_CHG_LVL=' + IS_CHG_LVL;
