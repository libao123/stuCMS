...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
        ...
        <div class="modal-dialog modal-dw60">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <label class="col-sm-2 control-label">
                        开放批次<span style="color: Red;">*</span></label>
                    <div class="col-sm-3">
                        <select name="BATCH_NO" id="BATCH_NO" class="form-control" ddl_name="ddl_batch"
                ...
                <fieldset class="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3" style="position: relative;">
                            <input type="text" name="FAMILY_START_TIME" id="FAMILY_START_TIME" class="form-control datep" />
                        </div>
                        <label class="col-sm-1 control-label">
                            至</label>
                        <div class="col-sm-3" style="position: relative;">
                            <input type="text" name="FAMILY_END_TIME" id="FAMILY_END_TIME" class="form-control datep" />
                        </div>
                    </div>
                </fieldset>
                <fieldset class="">
    ...
    <script type="text/javascript">
        ...
        function loadTableList() {
            ...
            tablePackage.filed = [
				...
				{ "data": "BATCH_NAME", "head": "开放批次", "type": "td-keep" },
    ...
    <script type="text/javascript">
        ...
        function loadModalPageDataInit() {
            ...
            DropDownUtils.initDropDown("BATCH_NO");
            //用户角色
            GetUserRoleHtml();
            //设置checkbox选中改变事件
        ...
        function loadModalBtnInit() {
            ...
            $dataModal.controls({
                ...
                "beforeSubmit": function () {
                    var result = AjaxUtils.getResponseText("?optype=check&oid=" + $("#OID").val() + "&schyear=" + $("#SCHYEAR").val() + "&batch=" + $("#BATCH_NO").val());
                    if (result.length > 0) {
                        easyAlert.timeShow({
                            "content": result,
                            "duration": 2,
