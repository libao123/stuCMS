<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AltMaster.Master" AutoEventWireup="true"
    CodeBehind="List.aspx.cs" Inherits="PorteffAnaly.Web.AdminLTE_Mod.SysParam.zd_zzmm.List" %>
    ...
    <div class="modal fade" id="tableModal">
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">政治面貌</h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label class="col-sm-4 control-label">字典代码</label>
                    <div class="col-sm-8">
                        <input name="DM" id="DM" type="text" class="form-control" maxlength="2" placeholder="字典代码" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-4 control-label">字典名称</label>
                    <div class="col-sm-8">
                        <input name="MC" id="MC" type="text" class="form-control" maxlength="16" placeholder="字典名称" />
                    </div>
                </div>
                <div class="form-group">
