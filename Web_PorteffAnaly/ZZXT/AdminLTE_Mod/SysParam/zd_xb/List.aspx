<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AltMaster.Master" AutoEventWireup="true"
    CodeBehind="List.aspx.cs" Inherits="PorteffAnaly.Web.AdminLTE_Mod.SysParam.zd_xb.List" %>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input name="MC" id="MC" type="text" class="form-control" maxlength="1" placeholder="字典名称" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-4 control-label">字典英文名称</label>
                    <div class="col-sm-8">
                        <input name="YWMC" id="YWMC" type="text" class="form-control" maxlength="10" placeholder="字典英文名称" />
                    </div>
                </div>
            </div>
