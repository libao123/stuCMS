<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AltMaster.Master" AutoEventWireup="true"
    CodeBehind="Process.aspx.cs" Inherits="PorteffAnaly.Web.AdminLTE_Mod.BDM.PersonalCenter.Process" %>
    ...
    <script type="text/javascript">
        ...
        function loadTableList() {
            ...
            tablePackage.filed = [
				...
				{ "data": "DOC_TYPE", "head": "已办事项", "type": "td-keep" }
                <%if (user.User_Role.Equals("S")) { %>
                , { "data": "RET_CHANNEL", "head": "状态", "type": "td-keep" }
                <% } else { %>
                , { "data": "QTY", "head": "已审数量", "type": "td-keep" }
                <% } %>
			];
